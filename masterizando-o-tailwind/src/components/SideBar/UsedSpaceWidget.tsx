    ...
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      <div className="space-y-1">
        ...
        <div className="h-2 rounded-full bg-violet-100 dark:bg-zinc-600">
          <div className="h-2 w-4/5 rounded-full bg-violet-600 dark:bg-violet-500"></div>
        </div>

        <div className="space-x-3">
          <button
            type="button"
            className="text-sm font-medium text-violet-500 hover:text-violet-100 dark:text-violet-300"
          >
            Dismiss
          </button>
          <button
            type="button"
            className="text-sm font-medium text-violet-600 dark:text-zinc-300 dark:hover:text-zinc-100"
          >
            Upgrade plan
          </button>
        </div>
