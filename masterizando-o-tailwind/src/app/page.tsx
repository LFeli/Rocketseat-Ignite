  ...
  return (
    <div className="p-8 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 h-screen flex flex-col items-center text-center">
      <div className="max-w-2xl">
        ...
        <button className="bg-sky-500 dark:bg-sky-400 text-white dark:text-sky-950 enabled:hover:bg-sky-700 transition-colors px-10 py-2 rounded font-medium mt-4 disabled:opacity-60 disabled:cursor-not-allowed">
          Sign in
        </button>
      </div>
